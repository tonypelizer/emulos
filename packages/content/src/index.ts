...
import catUti001 from "../cases/vet/cat-uti-001.json";
import dogOtitis001 from "../cases/vet/dog-otitis-001.json";
...
const CASE_REGISTRY: Record<string, unknown> = {
  "fever-001": fever001,
  "cat-uti-001": catUti001,
  "dog-otitis-001": dogOtitis001,
